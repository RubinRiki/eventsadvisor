...
from ..ui import Card, SectionTitle
...
class DetailsView(QWidget):
    def __init__(self, parent=None):
        ...
        root.addWidget(
            Muted("מיקום: היכל התרבות • תל אביב · תאריך: 15/10/2025 · מחיר החל מ-₪180")
        )
        ...
        cta_row = QHBoxLayout()
        buy = QPushButton("המשך להזמנה")
        buy.setObjectName("Primary")
        share = QPushButton("שתף")
        share.setObjectName("Secondary")
        cta_row.addWidget(buy)
        cta_row.addWidget(share)
